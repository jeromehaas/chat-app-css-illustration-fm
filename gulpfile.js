...
const filePaths = {
	scss: {
		src: ['./src/scss/configs/reset.scss', './src/scss/configs/variables.scss', './src/scss/configs/fonts.scss', './src/scss/configs/typography.scss', './src/scss/configs/keyframes.scss', './src/scss/configs/nucleo.scss', './src/scss/configs/global.scss', './src/scss/sections/**/*.scss'],
		dist: ['./css']
	},
	js: {
		src: ['./src/**/*.js'],
